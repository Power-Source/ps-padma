...
Instructions
--------------
1- Copy and paste this file to your plugin root directory or into the root file.
2- Unless you know how to edit code make sure that your plugin main file name is
   the same as plugin directory name.
3- Scroll down to the bottom of the file then change the data in variables
   $plugin_current_version, $plugin_remote_path, $plugin_slug, $plugin_id to
   your plugin data.
*/
