...
<h2><?php _e('Padma Templates','padma'); ?>
	...
	<a href="#export-template" class="add-new-h2 ps-modal-trigger" data-modal-target="export-template" id="export-template"><?php _e('Export Current Template','padma'); ?></a>
	<a href="#save-on-cloud" class="add-new-h2 ps-modal-trigger" data-modal-target="save-on-cloud" id="export-template"><?php _e('Save Template on Cloud','padma'); ?></a>
</h2>
