...
class PadmaListingBlockDisplay {
	...
	function display($args = array()) {
		...
		$listing_type = PadmaBlockAPI::get_setting($block, 'listing-type', 'taxonomy');
	...
	function display_taxonomy($args = array()) {
		...
		$args = array(
		    ...
		    'hide_empty'    => PadmaBlockAPI::get_setting($block, 'terms-hide-empty', 0), 
		    'exclude'       => PadmaBlockAPI::get_setting($block, 'terms-exclude', array()),
		    'exclude_tree'  => array(), 
		    'include'       => PadmaBlockAPI::get_setting($block, 'terms-include', array()),
		    'number'        => PadmaBlockAPI::get_setting($block, 'terms-number', '10'), 
		    'fields'        => 'all', 
		    'slug'          => PadmaBlockAPI::get_setting($block, 'terms-slug', ''), 
		    'parent'        => '',
		    'hierarchical'  => PadmaBlockAPI::get_setting($block, 'terms-hierarchical', true), 
		    'child_of'      => 0, 
		    'get'           => '', 
		    'name__like'    => '',
		    'pad_counts'    => false, 
	...
	function display_entry($args = array()) {
		...
		/* Setup Titles */
			$hide_title = PadmaLayoutOption::get($post_id, 'hide-title', false, true);
