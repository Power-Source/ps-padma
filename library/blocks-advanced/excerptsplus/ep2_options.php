    ...
    function modify_arguments($args = false)
    {
      ...
      $this->tab_notices = array(
          ...
          'info'          => 'Excerpts+ version: ' . EPVERSION . '<br/>
							...
							<strong>Support:</strong> Please log support requests to support@pizazzwp.com<br/>
							'
      );
    ...
    static function ep_opt_structure()
    {
      ...
      $settings  = array(
          ...
          'ep-use-pagination'         => array(
              'type'    => 'checkbox',
              'label'   => 'Pagination',
              'tooltip' => 'If enabled, it will display next/previous post enabling your users to page through your posts. <strong>Note: </strong>Never use Excerpts+ and Content blocks both with pagination on the same page. It will confuse your readers greatly. Also, due to a WordPress bug, pagination won\'t work on the home page if it is set to a static page in WP Settings, Reading. For your interest, this also affects the Padma Content block.',
              'default' => false,
              'name'    => 'use-pagination'
          ),
...
//			ep_options_update($block,$all_post_types_numeric);
      ...
      $settings    = array(
          ...
          'ep-post-inc-scheduled'       => array(
              'type'    => 'checkbox',
              'label'   => 'Include scheduled posts',
              'tooltip' => 'Include scheduled posts to give readers a teaser of what\'s coming. Note: ExcerptsPlus will never show full content from scheduled posts nor are they linked. They also have a specific class .scheduled so you can style them uniquely with custom CSS.',
              'default' => false,
              'name'    => 'post-inc-scheduled',
          ),
          'ep-post-ids'        => array(
              'type'    => 'text',
    ...
    static function ep_opt_titles()
    {
      $settings = array(
          ...
          'ep-hw-alt-titles'            => array(
              ...
              'tooltip' => 'In the post editor, Padma adds an option for shorter alternative titles. If you wish to display these when available, enable this setting.',
              'default' => true,
...
'ep-custom-fields-group1-repeater' => array(
    ...
    'inputs'   => array(
        ...
        array(
            'type'    => 'checkbox',
            'name'    => 'ep-custom-fields-is-date',
            'label'   => 'Is date',
            'default' => false,
            'tooltip' => 'Enable this if this custom field is a date. It will be formatted with your site\'s default date format.'
        ),
        array(
            'type'    => 'select',
 ...
 * ********************************** */
    ...
    static function get_settings($block)
    {
      ...
      foreach ($options as $option) {
        $settings[ $option[ 'name' ] ] = PadmaBlockAPI::get_setting($block, $option[ 'name' ], (!isset($option[ 'default' ]) ? null : $option[ 'default' ]));
      }
