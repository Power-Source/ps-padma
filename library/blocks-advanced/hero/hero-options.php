		...
		$this->inputs = array(
			'general' => array(
				...
				'subtitle' => array(
					...
					'tooltip' => __( 'Optionale Zeile oberhalb des Inhaltscontainers.', 'padma' ),
				),
				'content' => array(
					'name'    => 'content',
					'type'    => 'textarea',
					...
					'tooltip' => __( 'Beschreibungstext innerhalb des Inhaltscontainers.', 'padma' ),
				),
				'background_image' => array(
					...
					'default' => '',
					'tooltip' => __( 'Bild für den Hintergrund des Hero-Bereichs.', 'padma' ),
				),
				'button_text' => array(
					'name'    => 'button_text',
					'type'    => 'text',
					...
					'tooltip' => __( 'Text des optionalen Buttons.', 'padma' ),
				),
				'button_url' => array(
					'name'    => 'button_url',
					'type'    => 'text',
