...
class PadmaVisualElementsBlockPortfolioCards extends \PadmaBlockAPI {
	...
	public static function portfolio_admin_scripts() {
		...
		$script_path = PADMA_LIBRARY_DIR . '/blocks-advanced/portfolio-cards/portfolio-cards.js';
		$script_url = padma_url() . '/library/blocks-advanced/portfolio-cards/portfolio-cards.js';
	...
	public static function enqueue_action( $block_id, $block = false ) {
		...
		$script_path = PADMA_LIBRARY_DIR . '/blocks-advanced/portfolio-cards/portfolio-cards.js';
		$script_url = padma_url() . '/library/blocks-advanced/portfolio-cards/portfolio-cards.js';
		$style_path = PADMA_LIBRARY_DIR . '/blocks-advanced/portfolio-cards/portfolio-cards.css';
