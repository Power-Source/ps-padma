...
<div class="padma-admin-container">
	...
	<div id="welcome" class="padma-admin-tab" style="">	
		<div class="content">
			...
			<p><?php _e('Deine <strong>PS Padma</strong> Installation ist bereit.','padma'); ?></p>
			...
			<h2><?php _e('PS Padma – Kernfunktionen im ClassicPress-Dashboard / Admin-Menü.','padma'); ?></h2>
			<div class="box">
				<h3><?php _e('PS Padma – Willkommen!','padma'); ?></h3>
				<p><?php _e('(Diese Seite)','padma'); ?></p>
				<p><?php _e('Zugang zu ►','padma'); ?></p>
				<p><?php _e('Allgemeine Informationen, Dokumentation und Support für <b>PS Padma</b>.','padma'); ?></p>
				<p><?php _e('Blöcke und Vorlagen zur Erweiterung der Möglichkeiten von <b>PS Padma</b>.','padma'); ?></p>
			</div>
			

			<h2><?php _e('PS Padma starter users','padma'); ?></h2>
			<div class="box">
				<p><?php _e('Bitte lies die <a href="https://cp-psource.github.io/ps-padma/">PS Padma Dokumentation</a>.','padma'); ?></p>
			</div>


			<div class="box">
				<h3><?php _e('PS Padma Visual Editor','padma'); ?></h3>
				
				<p><?php _e('Der PS Padma Visual Editor ist ein leistungsstarkes Werkzeug zur Gestaltung von WordPress-Website-Layouts und -Vorlagen. Passe fast jedes visuelle Element deiner Website über eine grafische Oberfläche an (Code kann bei Bedarf einfach über den integrierten Code-Editor ergänzt werden).','padma'); ?></p>

				<p><?php _e('Erfahre mehr über die Plattform in der Dokumentation <a rel="noopener" href="https://power-source.github.io/ps-padma/blog/basics/before-using-the-visual-editor/">"Einführung in den PS Padma Visual Editor".</a>','padma'); ?></p>
	...
	<div id="options" class="padma-admin-tab" style="display:none">
		<div class="content">
			...
			<div class="box">
				...
				<p><?php _e('Um Speicherplatz freizugeben, lösche bitte PS Padma Snapshots.','padma'); ?></p>
			</div>
			<div class="box">
				<h3><?php _e('Zurücksetzen','padma'); ?></h3>
				<p><?php _e('Anweisungen zum Zurücksetzen deiner PS Padma Installation.','padma'); ?></p>
			</div>
		</div>
	</div>
	...
	<div id="need-help" class="padma-admin-tab" style="display:none">
		<div class="content">
			...
			<p><?php _e('PS Padma bietet professionellen Support und umfassende Dokumentation, um dir zu helfen, deine Projekte zum Leben zu erwecken.','padma'); ?></p>			
			<div class="separator"></div>
			<div class="box">
	...
	<div id="unlimited-growth" class="padma-admin-tab" style="display:none">
		<div class="content">
			...
			<div class="separator"></div>
			<div class="box">
				<h3><?php _e('PS Padma Templates','padma'); ?></h3>
				<p><?php _e('<strong>PS Padma Templates</strong> minimieren deinen Projektentwicklungsprozess, optimieren die Designphase und führen zu einer schnelleren Inhaltserstellung und -bereitstellung.','padma'); ?></p>
			</div>
			<div class="box">
				<h3><?php _e('PS Padma Blöcke','padma'); ?></h3>
				<p><?php _e('Erweitere die Funktionalität deiner PS Padma Installation, indem du nützliche benutzerdefinierte Blöcke zu deinen Projekten hinzufügst.','padma'); ?></p>
