...
class PadmaStoreBlockLoginButton extends \PadmaBlockAPI {
	...
	public static function enqueue_action($block_id, $block = false) {
		...
		$font_icons_path = PADMA_LIBRARY_DIR . '/blocks-advanced/store-login-button/font-icons.css';
		$font_icons_url = padma_url() . '/library/blocks-advanced/store-login-button/font-icons.css';

		/* CSS */
		if ( file_exists($font_icons_path) )
			wp_enqueue_style('padma-store-fonts', $font_icons_url, array(), PADMA_ADVANCED_VERSION, 'all');
